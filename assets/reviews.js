/* Two enhancements for the review strip. Both are optional: with no JavaScript
   the strip still scrolls, still pauses on hover, and reduced-motion users
   still get a static swipeable rail from CSS alone. */
(function () {
